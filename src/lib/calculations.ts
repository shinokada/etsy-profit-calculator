...
test: done
*/
export function calculateEtsyTransactionFee(
	salesPrice: number,
	shippingPrice: number,
	discountPrice: number
): number {
...
test: done
*/
export function calculateEtsyAdPrice(
	isEtsyAdPriceInDollars: boolean,
	etsyAdValue: number,
	salesPrice: number,
	discountPrice: number,
	hasEtsyAds: boolean
...
test: done
*/
export function calculateOffsiteAdPrice(
	salesPrice: number,
	discountPrice: number,
	offSitePercentage: number,
	hasOffsiteAds: boolean
): number {
...
export function calculateTotalFees(
	...
	const etsytransactionFee = calculateEtsyTransactionFee(salesPrice, shippingPrice, discountPrice);
...
test: done
*/
export function calculateTotalCoGSAndShipping(
	costOfItem: number,
	shippingCostForOrder: number
): number {
